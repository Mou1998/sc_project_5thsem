...
?>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Album Managment System</h1>
                        </div>
                    </div>
                    <!-- /.row -->
                </div>
                                ...
                                <div class="card-footer bg-transparent">
                                    <div class="row">
                                        <div class="col-4 text-center">
                                            ...
                                            <div class="text-white">Musician</div>
                                        </div>
                                        <!-- ./col -->
                                        <div class="col-4 text-center">
                                        ...
                                        <div class="col-4 text-center">
                                            ...
                                            <div class="text-white">Songs</div>
                                        </div>
                                        <!-- ./col -->
                                    </div>
                                    <!-- /.row -->
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2021-2022 <a href=#>Group One</a>.</strong>
